...
@section('title', 'Solicitud de Permisos/Vacaciones')

@section('content')
    <div class="card-header">
        <h1 class="card-title" style="font-size: 1.8rem;">
            <i class="fa fa-box mr-1"></i>
            <span>Solicitudes de Permisos/Vacaciones</span>
        </h1>
        
        @can('Vacaciones_crear')
    ...
    <div class="card table-responsive">
        <div class="card-body">
            ...
            <table class="table table-hover table-bordered" id="solicitud_vacacion">
...
@include('GestionSolicitudes.vacaciones.create')
