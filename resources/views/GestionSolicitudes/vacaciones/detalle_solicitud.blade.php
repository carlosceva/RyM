    ...
    <div class="card shadow-sm h-100 ">
        ...
        <div class="card-header {{ $clase_color }}">
            ...
            <div class="text-center mt-1">
                <strong>Solicitud de Permisos/Vacaciones</strong>
            </div>
        </div>
        ...
        <div class="card-footer {{ $clase_color }}">
            <div class="row">
                ...
                <div class="col d-flex align-items-center">
                    @can('Vacaciones_borrar')
                    <form action="{{ route('Vacaciones.destroy', $solicitud->id) }}" method="POST" onsubmit="return confirm('¿Estás seguro de que deseas anular esta solicitud?');" class="m-0">
                        @csrf
                        @method('DELETE')
                ...
                <div class="col-auto ms-auto d-flex align-items-center">
                    <a href="{{ route('vacacion.descargar.pdf', $solicitud->id) }}" class="btn btn-sm btn-pdf me-2" target="_blank">
