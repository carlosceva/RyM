...
@section('content')
    ...
    <div class="card table-responsive">
        <div class="card-body">
            ...
            <table class="table table-hover table-bordered" id="solicitud_extra">
                ...
                <tbody class="table-group-divider">
                  @foreach($solicitudes as $solicitud)
                    ...
                    <tr class="{{ $claseFila }}">
                        ...
                        <td>{{ $solicitud->extra?->tipo_extra }}</td>

                        <td>{{ $solicitud->glosa ?? 'S/NN' }}</td>      

                        <td>{{ $estado === 'confirmada' ? 'Registrada' : ucfirst($estado) }}</td>
    ...
    @include('GestionSolicitudes.extras.modal_confirmar', ['solicitud' => $solicitud])
    @endforeach

@include('GestionSolicitudes.extras.create')
