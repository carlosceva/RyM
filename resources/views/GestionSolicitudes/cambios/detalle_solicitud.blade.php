    ...
    <div class="card shadow-sm h-100 ">
        ...
        <div class="card-header {{ $clase_color }}">
            ...
            <div class="text-center mt-1">
                <strong>Cambios Fisicos de Mercaderia</strong>
            </div>
        </div>
        ...
        <div class="card-body">
            <div class="row">
                    ...
                    <p><strong>Nota de Venta:</strong> {{ $solicitud->cambioMercaderia->nota_venta ?? 'N/D' }}</p>

                    <p class="mb-2"><strong>Almacen:</strong> {{ $solicitud->cambioMercaderia->almacen_nombre?->nombre ?? 'N/A' }}</p>
                    ...
                    <div class="border p-2 rounded bg-light small">
                        ...
                        <table class="table table-borderless table-sm mb-0">
                            ...
                            <tbody>
                                @if(!empty($solicitud->cambioMercaderia->detalle_productos))
                                    @php $productos = explode(',', $solicitud->cambioMercaderia->detalle_productos); @endphp
        ...
        <div class="card-footer {{ $clase_color }}">
            <div class="row">
                ...
                <div class="col d-flex align-items-center">
                    @can('Cambio_borrar')
                    <form action="{{ route('CambiosFisicos.destroy', $solicitud->id) }}" method="POST" onsubmit="return confirm('¿Estás seguro de que deseas anular esta solicitud?');" class="m-0">
                        @csrf
                        @method('DELETE')
                    ...
                    <div class="d-flex flex-column flex-sm-row justify-content-center align-items-center">
                        ...
                        @if($solicitud->estado == 'confirmada')
                            ...
                            <button class="btn btn-sm btn-danger mb-2 mb-sm-0 me-sm-2 d-flex align-items-center justify-content-center"
                                ...
                                <i class="fa fa-times"> Reprobar</i>
                            </button>
                            @endcan
                ...
                <div class="col-auto ms-auto d-flex align-items-center">
                    <a href="{{ route('cambio.descargar.pdf', $solicitud->id) }}" class="btn btn-sm btn-pdf me-2" target="_blank">
