...
@section('title', 'Cambios fisicos de Mercaderia')

@section('content')
    <div class="card-header">
        <h1 class="card-title" style="font-size: 1.8rem;">
            <i class="fa fa-box mr-1"></i>
            <span>Solicitud de Cambios fisicos de Mercaderia</span>
        </h1>
    ...
    <div class="card table-responsive">
        <div class="card-body">
            ...
            <table class="table table-hover table-bordered" id="solicitud_cambio">
                <thead class="table-dark">
                    <tr>
                      ...
                      <th>Almacen</th>
                      <th>Motivo</th>                
                      <th class="d-none">Productos</th>             <!-- oculto -->
                      <th>Estado</th>
                ...
                <tbody class="table-group-divider">
                  @foreach($solicitudes as $solicitud)
                    ...
                    <tr class="{{ $claseFila }}">
                        ...
                        <td>{{ $solicitud->cambioMercaderia?->nota_venta }}</td>
                        <td>{{ $solicitud->cambioMercaderia?->almacen_nombre?->nombre ?? 'N/A' }} </td>
                        <td>{{ $solicitud->cambioMercaderia?->motivo ?? 'S/NN' }}</td>      
                        <td class="d-none">{{ $solicitud->cambioMercaderia?->detalle_productos ?? 'Sin detalle de productos' }}</td> <!-- oculto -->
...
@include('GestionSolicitudes.cambios.create')
