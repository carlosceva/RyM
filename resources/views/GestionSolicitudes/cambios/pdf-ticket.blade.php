...
<body>
    <div class="card">
        ...
        <div class="card-body mt-2">
            ...
            <p class="mb-1"><strong>Almacén:</strong> {{ $solicitud->cambioMercaderia->almacen_nombre?->nombre ?? 'N/A' }}</p>
            ...
            @if($solicitud->cambioMercaderia)
                <div class="mt-3">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            @php
                                $productos = explode(',', $solicitud->cambioMercaderia->detalle_productos ?? '');
                            @endphp
